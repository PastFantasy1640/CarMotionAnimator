...
cma::MStatusException::MStatusException(const MStatus & stat, const MString & message, const MString & place)
	: stat(stat), message(message), place(place)
{}

cma::MStatusException::~MStatusException() {}

MString cma::MStatusException::toString(void) const {
